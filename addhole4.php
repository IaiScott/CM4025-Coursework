...
<form action="addhole5.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #4<input type="hidden" name="holeno" value="4" readonly="readonly"></td>
    </tr>
    <tr>
