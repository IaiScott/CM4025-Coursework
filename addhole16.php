...
<form action="addhole17.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #16<input type="hidden" name="holeno" value="16" readonly="readonly"></td>
    </tr>
    <tr>
