...
<form action="addhole10.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #9<input type="hidden" name="holeno" value="9" readonly="readonly"></td>
    </tr>
    <tr>
