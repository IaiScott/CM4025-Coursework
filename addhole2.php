...
<form action="addhole3.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #2<input type="hidden" name="holeno" value="2" readonly="readonly"></td>
    </tr>
    <tr>
