...
<form action="addhole7.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #6<input type="hidden" name="holeno" value="6" readonly="readonly"></td>
    </tr>
    <tr>
