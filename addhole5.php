...
<form action="addhole6.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #5<input type="hidden" name="holeno" value="5" readonly="readonly"></td>
    </tr>
    <tr>
