...
<form action="addhole18.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #17<input type="hidden" name="holeno" value="17" readonly="readonly"></td>
    </tr>
    <tr>
