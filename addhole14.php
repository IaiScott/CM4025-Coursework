...
<form action="addhole15.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #14<input type="hidden" name="holeno" value="14" readonly="readonly"></td>
    </tr>
    <tr>
