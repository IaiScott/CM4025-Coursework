...
<form action="addhole14.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #13<input type="hidden" name="holeno" value="13" readonly="readonly"></td>
    </tr>
    <tr>
