...
if ((isset($_COOKIE['playerid']))&&(basename($_SERVER['PHP_SELF']) != 'logout.php')){
?>
	...
	<section>
    		<div class="container">
        		...
        		<div class="box-title"><img src="img/warning.png" class="box-icon"> You're already registered!</div>
		<div id="title-description">Please sign-in.</div>
        		<section class ="sp25px"></section>
        		<section><img src="img/oops_man.png" id="oops"></section>
...
?>
	...
	<tr>
            ...
            <tr>
                <td><input type="hidden" name="access" class="pad-box" id="form-square" maxlength="30" value="user" readonly="readonly" /></td>
            </tr> 
            <tr>
