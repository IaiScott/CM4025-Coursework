...
<form action="addhole16.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #15<input type="hidden" name="holeno" value="15" readonly="readonly"></td>
    </tr>
    <tr>
