...
<form action="addhole12.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #11<input type="hidden" name="holeno" value="11" readonly="readonly"></td>
    </tr>
    <tr>
