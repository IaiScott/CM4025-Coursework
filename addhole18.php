...
<form action="addedholes.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #18<input type="hidden" name="holeno" value="18" readonly="readonly"></td>
    </tr>
    <tr>
