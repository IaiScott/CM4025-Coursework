...
<form action="addhole9.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #8<input type="hidden" name="holeno" value="8" readonly="readonly"></td>
    </tr>
    <tr>
