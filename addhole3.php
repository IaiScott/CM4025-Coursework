...
<form action="addhole4.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #3<input type="hidden" name="holeno" value="3" readonly="readonly"></td>
    </tr>
    <tr>
