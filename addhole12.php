...
<form action="addhole13.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #12<input type="hidden" name="holeno" value="12" readonly="readonly"></td>
    </tr>
    <tr>
