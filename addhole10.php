...
<form action="addhole11.php" method="POST" enctype="multipart/form-data">
    ...
    <tr>
        <td class="title" colspan ="4">Hole: #10<input type="hidden" name="holeno" value="10" readonly="readonly"></td>
    </tr>
    <tr>
